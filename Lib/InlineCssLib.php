...
class InlineCssLib {
	...
	protected function _processEmogrifier($html, $css) {
		...
		App::import('Vendor', 'Emogrifier', array('file' => 'Emogrifier/Emogrifier.php'));
	...
	protected function _processCssToInline($html, $css) {
		App::import('Vendor', 'CssToInlineStyles', array('file' => 'CssToInlineStyles' . DS . 'CssToInlineStyles.php'));
