 ...
 */
if (!defined('ROOT')) {
	define('ROOT', DS.'home'.DS.'zumasoft');
}
 ...
 */
if (!defined('APP_DIR')) {
	define('APP_DIR', DS  . 'public_html' . DS . 'smartschool1');
}
...
define('CAKE_CORE_INCLUDE_PATH', DS . 'home' . DS . 'zumasoft' . DS . 'cakephp' . DS . 'lib');
...
if (!defined('WEBROOT_DIR')) {
	define('WEBROOT_DIR', basename(dirname(dirname(__FILE__))) . DS . 'public_html' . DS . 'smartschool1' . DS . 'webroot');
}
if (!defined('WWW_ROOT')) {
...
if (!defined('DEVELOPER_SITE_ADDRESS')) {
	define('DEVELOPER_SITE_ADDRESS', 'http://zumasoftwares.net');
}
...
if (!defined('DEVELOPER_SITE_EMAIL')) {
	define('DEVELOPER_SITE_EMAIL', 'noreply@zumasoftwares.net');
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
