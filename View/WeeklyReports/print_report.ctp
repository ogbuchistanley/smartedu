        ...
        <div style="position:relative">
            ...
            <div id="apDiv1">
                <table class="table table-bordered" width="750" style="margin-top: 65px;">
                    <caption style="font-weight: bolder">Weekly Subject Continuous Assessment (C.A) / Weight Points
                        (W.A)
                    </caption>
                    <?php if (!empty($Subjects)): ?>
                        ...
                        <tr style="font-weight:bold; background-color:#CCCCCC;">
                            <th width="8"></th>
                            <th width="800" colspan="<?php echo $marked_report + 1; ?>" style="text-align: center">
                                Weekly Report Assessment Scores
                            </th>
                        </tr>
                        <?php
...
//                                        var_dump($MidTermScores[$h - 1]);
                                        ...
                                        if ($j == $TermScore['a']['weekly_report_no']) {
                                            $totalScore += $TermScore['a']['weekly_ca'];
                                            $totalmarkObtainable += $TermScore['a']['weekly_weight_point'];
                ...
                <div>
                    ...
                    <p>Principal Stamp and Signature ____________________________________________</p>
                    <hr>
                </div>
