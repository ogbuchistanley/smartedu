...
<!-- Angular-->
<?php echo $this->Html->script("../app/jquery/custom.angular.js", FALSE);?>
...
<div class="col-md-12">
    <div class="panel">
        ...
        <?php 
            $count = 1;
        ?>
            <div class="col-md-6" ng-repeat="record in records">
                    ...
                    <div class="panel-body nopadding">
                        ...
                        <div class="row visitors-list-summary text-center">
                            <div class="col-md-4 col-sm-4 col-xs-4 visitor-item ">
                                ...
                                Total Paid <br />
                                <label class="label label-success" id="total_paid"></label>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-4 visitor-item">
                                <i class="fa fa-times fa-3x pull-left"></i>
                                Total Not Paid <br />
                                <label class="label label-danger" id="total_Npaid"></label>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-4 visitor-item">
                                <i class="fa fa-user fa-3x pull-left"></i>
                                Total Students <br />
                                <label class="label label-primary" id="total_students"></label>
                            </div>
                        </div>
                    </div>
                </div>
