    ...
    <div class="panel">
        ...
        <div class="panel-heading text-primary">
            <h3 class="panel-title">
               <i class="fa fa-male"></i> Summary of Student Terminal School Fees Charges
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a target="__blank" href="<?php echo DOMAIN_NAME ?>/students/view/<?php echo $encrypted_student_id; ?>" class="btn btn-primary btn-medium">
                                        ...
                                        <tr>
                                            <th>Sponsor Name</th>
                                            <td>
                                                <a target="__blank" href="<?php echo DOMAIN_NAME ?>/sponsors/view/<?php echo $Info['sponsor_id']; ?>" class="btn-link">
                                                    <?php echo $Info['salutation_name'], ' ', $Info['sponsor_name']; ?>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                          ...
                                          <td style="font-size: medium">
                                            <?php 
                                                if($Info['order_status_id'] === '1'){
                                                    echo '<button title="1" value="'.$Info['order_id'].'" class="btn btn-success btn-xs order_status_edit">'
                                                        . '<i class="fa fa-check-square-o fa-1x"></i><span class="label label-success">Paid</span></button>';
                                                }else{
                                                    echo '<button title="2" value="'.$Info['order_id'].'" class="btn btn-danger  btn-xs order_status_edit">'
                                  ...
                                  <tbody>
                                    ...
                                    <?php foreach ($ItemBills['ItemBill'] as $ItemBill): ?>
                                        <tr>
                                           ...
                                           <td><?php echo h(number_format($ItemBill['price'], 2, '.', ','));?></td>
                                           <td><?php $gTotal += $ItemBill['subtotal'];  echo h(number_format($ItemBill['subtotal'], 2, '.', ','));?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                   </tbody>
                                   <tfoot>
