                    ...
                    <div class="panel-body">
                        ...
                        <!--form class="form-horizontal cascde-forms" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate"-->
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-7 col-md-9">
                                  <input type="tel" class="form-control form-cascade-control input-small" name="data[Sponsor][mobile_number1]"
                                         value="<?php echo $sponsor['Sponsor']['mobile_number1']?>" id="mobile_number1" placeholder="Parent's Mobile number One"  required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-7 col-md-9">
                                    <input type="tel" class="form-control form-cascade-control input-small" name="data[Sponsor][mobile_number2]"
...
<?php
    ...
    echo $this->Js->buffer('
        setTabActive("[href=\"'.DOMAIN_NAME.'/sponsors/adjust\"]", 0);
    ');
?> 
<?php
