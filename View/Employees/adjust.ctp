                                        ...
                                        <div class="panel-body">
                                                ...
                                                <div class="col-lg-7 col-md-9">
                                                    <?php 
                                                        echo $this->Form->input('gender', array(
                                                                ...
                                                                'empty' => '(Select Employee\'s Gender)'
                                                            )
                                                        );  
                                                    ?>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7 col-md-">
                                                    <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][birth_date]" placeholder="Select Employee's date of birth" 
                                                ...
                                                <div class="col-lg-7 col-md-9">
                                                    <?php 
                                                        echo $this->Form->input('marital_status', array(
                                                                ...
                                                                'empty' => '(Select Employee\'s Marital Status)'
                                                            )
                                                        );  
                                                    ?>
                                                </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-7 col-md-">
                                                                ...
                                                                <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][spouse_name]" placeholder="Type Employee's Spouse Names"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-7 col-md-">
                                                                <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][spouse_employer]"  placeholder="Type Employee's Spouse Employer"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-7 col-md-">
                                                                <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][spouse_number]" placeholder="Type Employee's Spouse Phone Number"
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <div class="col-lg-7 col-md-9">
                                                    <?php 
                                                        echo $this->Form->input('form_of_identity', array(
                                                                ...
                                                                'empty' => '(Select Employee\'s Form of Identification)'
                                                            )
                                                        );  
                                                    ?>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7 col-md-">
                                                    ...
                                                    ?>
                                                    <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][identity_expiry_date]"  placeholder="Type Employee's I.D Expiry Date"
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-lg-7 col-md-9">
                                                ...
                                                value="<?php echo (empty($employee['Employee']['email'])) ? '' : $employee['Employee']['email'];?>" id="email" placeholder="Employee's e-mail">
                                              </div>
                                            </div>
                                            <div class="form-group">
                                              ...
                                              <div class="col-lg-7 col-md-9">
                                                ...
                                                value="<?php echo $employee['Employee']['mobile_number1']?>" id="mobile_number1" placeholder="Employee's Mobile number One" required>
                                              </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7 col-md-9">
                                                    ...
                                                    value="<?php echo !empty($employee['Employee']['mobile_number2']) ? $employee['Employee']['mobile_number2'] : '';?>" id="mobile_number2" placeholder="Employee's Mobile number Two if any">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <div class="col-lg-7 col-md-9">
                                                        <input type="next_ofkin_name" class="form-control form-cascade-control input-small" name="data[Employee][next_ofkin_name]"  placeholder="Employee's Next of Kin Name"
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <div class="col-lg-7 col-md-9">
                                                            <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][next_ofkin_number]"  placeholder="Employee's Next of Kin Mobile No."
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-7 col-md-9">
                                                            <input type="text" class="form-control form-cascade-control input-small" name="data[Employee][next_ofkin_relate]"  placeholder="Employee's Next of Kin Relationship"
                                                        ...
                                                        <?php $i=1; foreach ($EmpQuas as $EmpQua): ?>
                                                            <tr class="gradeA">
                                                               ...
                                                               <td>
                                                                   ...
                                                                   placeholder="Employee's Institution" required><?php echo h($EmpQua['EmployeeQualification']['institution']);?></textarea>
                                                               </td>
                                                               <td>
...
<?php
    //on click of Edit Employee Record link... activate the link
    echo $this->Js->buffer('
