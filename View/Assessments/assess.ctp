                                        ...
                                        <div class="panel-heading panel-title  text-white">Skills Assessment Form</div>
                                            ...
                                            <?php
                                                ...
                                                echo $this->Form->create('Assessment', array(
                                                        'action' => 'assess/' . $encrypted_student_id,
                                            ...
                                            ?>
                                                <?php if($Skills) :?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden"  name="data[Assessment][skill_assessment_id]">
                                                        <div class="col-lg-6 col-md-3">
                                                            <label class="radio-inline">
                                                                <input type="radio" class="flat-input" required="required" name="data[Assessment][<?php echo $skill['Skill']['skill_id']?>]" value="5"> 5
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="flat-input" required="required" name="data[Assessment][<?php echo $skill['Skill']['skill_id']?>]" value="4"> 4
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" class="flat-input" required="required" name="data[Assessment][<?php echo $skill['Skill']['skill_id']?>]" value="3"> 3
                                                            </label>
                                                            <label class="checkbox-inline">
                                                                <input type="radio" class="flat-input" required="required" name="data[Assessment][<?php echo $skill['Skill']['skill_id']?>]" value="2"> 2
                                                            </label>
                                                            <label class="checkbox-inline">
                                                                <input type="radio" class="flat-input" required="required" name="data[Assessment][<?php echo $skill['Skill']['skill_id']?>]" value="1"> 1
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <?php endforeach; ?><br>
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <button type="submit" class="btn btn-info">Save Records</button><span></span>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </form>
