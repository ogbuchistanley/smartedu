...
--
-- Host: localhost
-- Generation Time: May 20, 2015 at 02:02 PM
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`user_id`), ADD UNIQUE KEY `username` (`username`), ADD KEY `user_role_id` (`user_role_id`);
...
--
ALTER TABLE `subject_classlevels`
MODIFY `subject_classlevel_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=94;
--
...
--
ALTER TABLE `weekly_detail_setups`
MODIFY `weekly_detail_setup_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `weekly_report_setups`
MODIFY `weekly_report_setup_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
